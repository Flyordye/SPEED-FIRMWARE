 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 4
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 10*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS   1     // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z    0.01     // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY   0     // (steps or mm) Steps or millimeter distance for each XY babystep
