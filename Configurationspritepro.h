...
#define STRING_CONFIG_H_AUTHOR "(Eric Holliday, Ender3spritePROSPEED)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 SPEED FW"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 429.9 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 50, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-32, -40.5, 0}
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + X_MIN_POS)  // Extended max to allow the probe to reach more of the bed.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 40, 50 } // (mm) Left, Front, Right, Back insets
