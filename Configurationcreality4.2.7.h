...
#define CONFIG_EXAMPLES_DIR "config/examples/Creality/Ender-3 V2/CrealityV427/MarlinUI"
...
#define STRING_CONFIG_H_AUTHOR "(Eric Holliday, Ender3 v2)" // Who made the changes.
