...
#define STRING_CONFIG_H_AUTHOR "(Eric Holliday, Ender 5 PLUS SPEED)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 5 PLUS SPEED"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.80, -40.50, 0 }
