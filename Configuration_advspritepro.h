...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.005 }    // (mm) Compression length per 1mm/s extruder speed, per extruder 0.22 start bowden 0.005 start for dd
  #else
    #define ADVANCE_K 0.005        // (mm) Compression length applying to all extruders
  #endif
