...
#define STRING_CONFIG_H_AUTHOR "(Eric Holliday, Ender3 PRO SPEED)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 PRO SPEED"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.62 }
...
#define CR10_STOCKDISPLAY
  ...
  #define RET6_12864_LCD  // Specific to the SoC (can either be RET / VET) (old ender 3 screen)
  //#define VET6_12864_LCD  // Specific to the SoC (can either be RET / VET) (old ender 3 screen)
#endif
