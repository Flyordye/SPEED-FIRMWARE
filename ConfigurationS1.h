...
#define STRING_CONFIG_H_AUTHOR "(Eric Holliday, Ender 3 S1 F4)" // Who made the changes.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 40, 40 } // (mm) Left, Front, Right, Back insets
